...
const closeBtnObs = fromEvent(closeBtn, "click");
const createNoteBtnObs = fromEvent(createNoteBtn, "click");
const addNoteBtnObs = fromEvent(addNote, "click");

const closeButtonSub = closeBtnObs.subscribe(
  (event) => (createNote.style.display = "none")
);
...
const addNoteSub = addNoteBtnObs.subscribe((event) => {
...
const createNoteBtnSub = createNoteBtnObs.subscribe((event) => {
